            ...
            <UCard>
                <UCard class="mx-4">
                    <div class="flex gap-2">
                        <!-- <UButton @click="saveByteArray('summary.pdf', summary.data.result.summaryBuf)" label="Summary" icon="i-heroicons-arrow-down" />
                        <UButton @click="saveByteArray('transcript.pdf', summary.data.result.transcriptBuf)" label="Transcript" icon="i-heroicons-arrow-down" color="gray" /> -->
                        <h1 class="text-2xl font-semibold flex items-center gap-2 justify-between w-full">
                            <div class="flex gap-2 items-center">
                                <UButton class="mx-4" icon="i-heroicons-arrow-left" @click="navigateTo('/');" />
                ...
                <div class="flex justify-between pt-4">
                    ...
                    <!-- <span>Hashtags: {{ summary.data.result.hashtags }}</span> -->
                </div>
                ...
                <div class="flex gap-1">
                    Hashtags: 
                    <UBadge v-for="tag in summary.data.result.hashtags" :label="tag" variant="soft" />
                </div>
                <div v-for="topic in summary.data.result.topics" class="flex flex-col gap-2 w-72">
                    <UCard v-if="topic.name">
